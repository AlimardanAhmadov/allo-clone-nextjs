...
const MovingPasta = () => {
    ...
    return (
        <div className="moving-pasta" style={style}>
            <SvgAnimation path="/images/pasta.json" containerId="pasta-container" />
        </div>
    );
}

export default MovingPasta;
